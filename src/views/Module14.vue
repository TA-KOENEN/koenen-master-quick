        ...
        <v-col cols="12" md="6" class="d-flex justify-center">
          <v-card class="ma-10 transparent" outlined width="100%">
            ...
            <step-text
              ...
              :kleur="colorStep6"
            />
            <div id="step7" v-if="memberData.step === 6">
              <CustomDivider />
...
import textData from "@/text/textN.json";
...
export default {
  ...
  methods: {
    ...
    saveResults() {
      ...
      this.saving = true;
      ResultService.saveResultN(payload).then(() => {
    ...
    getReport() {
      ...
      ResultService.getReportN(payload)
        .then(() => {})
        .finally(() => {
    ...
    getStatement() {
      this.loading = true;
      StatementService.getStatementN().then((response) => {
