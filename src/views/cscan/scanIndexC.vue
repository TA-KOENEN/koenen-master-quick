...
<script>
import leftText from "@/text/scanC/textLeft.json";
import stepText from "@/text/scanC/textStep.json";
import questionText from "@/text/scanC/textStatement.json";
import AstepQuickC from "@/components/qsC/AstepQuickC";
import BstepQuickC from "@/components/qsC/BstepQuickC";
import CstepQuickC from "@/components/qsC/CstepQuickC";
import DstepQuickC from "@/components/qsC/DstepQuickC";
import EstepQuickC from "@/components/qsC/EstepQuickC";
import FstepQuickC from "@/components/qsC/FstepQuickC";
import GstepQuickC from "@/components/qsC/GstepQuickC";
...
export default {
  ...
  methods: {
    ...
    async getReport() {
      ...
      try {
        ...
        await ResultService.getReportC(payload);
        // eslint-disable-next-line no-undef
        await EventBus.$emit("reportSend", true);

        await this.sleep(1000);
        await AuthService.logoutC(payloadLog);
        localStorage.clear();
  ...
  computed: {
    ...
    cb_a: {
      get() {
        return this.$store.state.quickC.cb_a;
      },
    },
    cb_b: {
      get() {
        return this.$store.state.quickC.cb_b;
      },
    },
    cb_c: {
      get() {
        return this.$store.state.quickC.cb_c;
      },
    },
    cb_d: {
      get() {
        return this.$store.state.quickC.cb_d;
      },
    },
    cb_e: {
      get() {
        return this.$store.state.quickC.cb_e;
      },
    },
    cb_f: {
      get() {
        return this.$store.state.quickC.cb_f;
      },
    },
    question_a: {
      get() {
    ...
    question_b: {
      get() {
        return this.$store.state.quickC.question_b;
      },
    },
    question_c: {
      get() {
    ...
    question_e: {
      get() {
        return this.$store.state.quickC.question_e;
      },
    },
    question_f: {
      get() {
        return this.$store.state.quickC.question_f;
      },
    },
    text_a: {
      get() {
    ...
    text_b: {
      get() {
        return this.$store.state.quickC.text_b;
      },
    },
    text_c: {
      get() {
        return this.$store.state.quickC.text_c;
      },
    },
