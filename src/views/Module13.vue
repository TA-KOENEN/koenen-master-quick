        ...
        <v-col cols="12" md="6" class="d-flex justify-center">
          <v-card class="ma-10 transparent" outlined width="100%">
            ...
            <step-text
              ...
              :kleur="colorStep9"
            />
            <div id="step10" v-if="memberData.step === 9">
              <CustomDivider />
...
import textData from "@/text/textM.json";
...
export default {
  ...
  methods: {
    ...
    saveResults() {
      ...
      this.saving = true;
      ResultService.saveResultM(payload).then(() => {
    ...
    getReport() {
      ...
      ResultService.getReportM(payload)
        .then(() => {})
        .finally(() => {
    ...
    getStatement() {
      this.loading = true;
      StatementService.getStatementM().then((response) => {
    ...
    getData() {
      ...
      this.loading1 = true;
      ResultService.getResultM(payload).then((response) => {
        console.log("dataklant terug");
        this.memberData = response.data.data.mlightmodule;
        this.loading1 = false;
      });
    },
  },
