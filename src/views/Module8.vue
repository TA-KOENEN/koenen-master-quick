...
import textData from "@/text/textH.json";
...
export default {
  ...
  methods: {
    ...
    saveResults() {
      ...
      this.saving = true;
      ResultService.saveResultH(payload).then(() => {
    ...
    getReport() {
      ...
      ResultService.getReportH(payload)
        .then(() => {})
        .finally(() => {
    ...
    getStatement() {
      this.loading = true;
      StatementService.getStatementH().then((response) => {
