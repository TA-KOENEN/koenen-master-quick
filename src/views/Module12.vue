...
import textData from "@/text/textL.json";
...
export default {
  ...
  methods: {
    ...
    saveResults() {
      ...
      this.saving = true;
      ResultService.saveResultL(payload).then(() => {
    ...
    getReport() {
      ...
      ResultService.getReportL(payload)
        .then(() => {})
        .finally(() => {
    ...
    getStatement() {
      this.loading = true;
      StatementService.getStatementL().then((response) => {
